...
void MD5(LPCWSTR pwzInfo, wchar_t wzOutBuf[34])
{
	...
	uint8_t result[16] = { 0 };
	md5((uint8_t*) pwzInfo, wcslen(pwzInfo) * sizeof(wchar_t), result);
...
void MD5(LPCSTR pszInfo, char szOutBuf[34])
{
	...
	uint8_t result[16] = {0};
	md5((uint8_t*) pszInfo,strlen(pszInfo) , result);
...
void MD5(LPCWSTR pwzInfo, size_t nSize, wchar_t wzOutBuf[34])
{
	...
	uint8_t result[16] = { 0 };
	md5((uint8_t*) pwzInfo, nSize, result);
...
void MD5(LPCSTR pszInfo, size_t nSize, char szOutBuf[34])
{
	...
	uint8_t result[16] = { 0 };
	md5((uint8_t*) pszInfo, nSize, result);
